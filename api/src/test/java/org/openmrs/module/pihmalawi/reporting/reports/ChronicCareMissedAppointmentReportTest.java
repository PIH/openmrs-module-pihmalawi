 ...
 */
public class ChronicCareMissedAppointmentReportTest extends ReportManagerTest {
	...
	@Autowired
	ChronicCareMissedAppointmentReport ccMissedAppointmentReport;

	@Override
	public ReportManager getReportManager() {
		return ccMissedAppointmentReport;
	}
