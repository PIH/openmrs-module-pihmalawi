 ...
 */
public class HccMissedAppointmentReportTest extends ReportManagerTest {
	...
	@Autowired
	HccMissedAppointmentReport hccMissedAppointmentReport;

	@Override
	public ReportManager getReportManager() {
		return hccMissedAppointmentReport;
	}
