 ...
 */
public class ChronicCareIndicatorReportTest extends ReportManagerTest {
	...
	@Autowired
	ChronicCareIndicatorReport chronicCareIndicatorReport;

	@Override
	public ReportManager getReportManager() {
		return chronicCareIndicatorReport;
	}
