...
select convert(substring_index(opi.identifier,' ',-1),SIGNED) as sort_value,opi.identifier, l.source_key as location_key, mwp.first_name, mwp.last_name, ops.state,ops.start_date, mwp.gender,
 ...
 ops.location, patient_visit.last_appt_date, patient_visit.art_regimen as current_regimen, patient_visit.ctx_960, patient_visit.ctx_960_pills,patient_visit.inh_300,
 patient_visit.inh_300_pills,patient_visit.rfp_150,patient_visit.rfp_150_pills,
...
map.ctx_960,map.ctx_960_pills,map.inh_300,map.inh_300_pills,map.rfp_150,map.rfp_150_pills, map.pregnant_or_lactating
