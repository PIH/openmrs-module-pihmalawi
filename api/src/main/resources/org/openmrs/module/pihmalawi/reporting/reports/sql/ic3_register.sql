...
SELECT
  ...
  date_format(ic3EnrollmentDate,'%m/%d/%Y') as "Date of First Enrollment in HIV/Chronic Care Programs",
  ic3FirstProgramEnrolled as "First Program Enrollment",
  date_format(ncdEnrollmentDate,'%m/%d/%Y') as "NCD Program Enrollment Date",
  lastNcdOutcome as "NCD Program Outcome",
  date_format(lastNcdOutcomeDate,'%m/%d/%Y') as "NCD Program Outcome Date",
  lastNcdVisitLocation as "NCD last visit location",
  date_format(lastNcdVisitDate,'%m/%d/%Y') as "NCD last visit date",
  date_format(lastHtnDmVisitDate,'%m/%d/%Y') as "Last Hypertension/Diabetes encounter date",
  date_format(lastEpilepsyVisitDate,'%m/%d/%Y') as "Last Epilepsy encounter date",
  date_format(lastChronicLungVisitDate,'%m/%d/%Y') as "Last Chronic Lung Diseasee Enounter date",
  date_format(lastMentalHealthVisitDate,'%m/%d/%Y') as "Last Mental Health encounter date",
  date_format(hivEnrollmentDate,'%m/%d/%Y') as "HIV Program Enrollment Date",
  lastHivOutcome as "HIV Program Outcome",
  date_format(lastHivOutcomeDate,'%m/%d/%Y') as "HIV Program Outcome Date",
  lastHivVisitLocation as "HIV last visit location",
  date_format(lastHivVisitDate,'%m/%d/%Y') as "HIV last visit date",
  date_format(lastVisitDate,'%m/%d/%Y') as "Last IC3 visit date",
  ...
  age as "Current Age",
-- VHW here  
  date_format(firstHivVisitDate,'%m/%d/%Y') as "HIV Program first visit date",
  date_format(artInitialDate,'%m/%d/%Y') as "ART initial date",
  lastTbValueInHiv as "Last TB status in HIV program", 
  date_format(lastTbDateInHiv,'%m/%d/%Y') as "Last TB Status Date",
  date_format(firstViralLoadDate,'%m/%d/%Y') as "Date of first viral load",
  firstViralLoadResult as "First viral load result",
  date_format(lastViralLoadDate,'%m/%d/%Y') as "Date of most recent viral load",
  lastViralLoadResult as "Most recent viral load result",
  date_format(lastArtRegimenStart,'%m/%d/%Y') as "ART Current regimen start date",
  lastArtRegimen as "ART Current Regimen",
  htnDx as "Hypertension Diagnosis",
  date_format(firstHtnDxDate,'%m/%d/%Y') as "Hypertension Diagnosis Date",
  date_format(firstHtnMedsDate,'%m/%d/%Y') as "First Hypertension Treatment Date",
  date_format(lastHtnMedsDate,'%m/%d/%Y') as "Last Hypertension Treatment Date",
  lastHtnMedsLocation as "Last Hypertension Treatment Location",
  firstBp as "First BP Measurment",
  date_format(firstBpDate,'%m/%d/%Y') as "First BP Measurement Date",
  lastBp as "Most recent BP Measurement",  
  date_format(lastBpDate,'%m/%d/%Y') as "Most recent BP Measurement Date",
  ...
  date_format(firstDmDxDate,'%m/%d/%Y') as "Diabetes Diagnosis Date",
  diabetesType as "Diabetes Type",
  firstDmMedsDate "First Diabetes Treatment Date",
  date_format(lastDmMedsDate,'%m/%d/%Y') as "Last Diabetes Treatment Date",
  lastDmMedsLocation as "Last Diabetes Treatment Location",
  date_format(firstGlucoseMonitoringDate,'%m/%d/%Y') as "Date of first visit with glucose monitoring",
  ...
  date_format(lastGlucoseMonitoringDate,'%m/%d/%Y') as "Date of last visit with glucose monitoring",
  ...
  date_format(firstEpilepsyDxDate,'%m/%d/%Y') as "Epilepsy Diagnosis Date",
  date_format(epilepsyOnsetDate,'%m/%d/%Y') as "Epilepsy Onset Date",
  date_format(firstEpilepsyMedsDate,'%m/%d/%Y') as "First Epilepsy Treatment Date",
  date_format(lastEpilepsyMedsDate,'%m/%d/%Y') as "Last Epilepsy Treatment Date",
  lastEpilepsyMedsLocation as "First Epilepsy Treatment Location",
  date_format(firstSeizuresDate,'%m/%d/%Y') as "Date seizures first reported to clinician",
  firstSeizures as "Number of seizures first recorded",
  date_format(lastSeizuresDate,'%m/%d/%Y') as "Date seizures last reported to clinician",
  lastSeizures as "Last number of seizures recorded",
  seizureTriggers as "Seizure triggers",
  asthmaDx as "Asthma Diagnosis",
  date_format(firstAsthmaDxDate,'%m/%d/%Y') as "Asthma Diagnosis Date",
  copdDx as "COPD Diagnosis",
  date_format(copdDiagnosisDate,'%m/%d/%Y') as "COPD Diagnosis Date",
  date_format(firstChronicLungMedsDate,'%m/%d/%Y') as "First Chronic Lung Treatment Date",
  date_format(lastChronicLungMedsDate,'%m/%d/%Y') as "Last Chronic Lung Treatment Date",
  lastChronicLungMedsLocation as "Last Chronic Lung Treatment Location",
  date_format(firstAsthmaSeverityDate,'%m/%d/%Y') as "First Asthma Severity Date",
  firstAsthmaSeverity as "First Asthma Severity",
  date_format(lastAsthmaSeverityDate,'%m/%d/%Y') as "Last Asthma Severity Date",
  ...
  date_format(firstMentalHealthDxDate,'%m/%d/%Y') as "Mental Health Diagnosis Date",
  date_format(firstMentalHealthMedsDate,'%m/%d/%Y') as "First Mental Health Treatment Date",
  date_format(lastMentalHealthMedsDate,'%m/%d/%Y') "Last Mental Health Treatement Date",
  lastMentalHealthMedsLocation "Last Mental Health Treatment Location",
  date_format(lastWeightDate,'%m/%d/%Y') "Last Weight Date",
  lastHeight "Last Height",
  lastWeight "Last Weight",
  CASE WHEN age >= 19 
    THEN round(lastWeight/POWER(lastHeight/100,2),1)
  END AS BMI,
  date_format(artAptDate,'%m/%d/%Y') as "Next ART Appointment",
  date_format(htnDmAptDate,'%m/%d/%Y') as "Next Hypertension/Diabetes Appointment",
  date_format(epilepsyAptDate,'%m/%d/%Y') as "Next Epilepsy Appointment",
  date_format(chronicLungAptDate,'%m/%d/%Y') as "Next Chronic Lung Appointment",
  date_format(mentalHealthAptDate,'%m/%d/%Y') as "Next Mental Health Appointment"
