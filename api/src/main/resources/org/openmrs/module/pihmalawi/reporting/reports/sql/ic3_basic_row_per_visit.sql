...
max(CASE when cq.UUID = '0e447d92-a180-11e8-98d0-529269fb1459' then cna.name end) "EID Reason for no sample",
max(CASE when cq.UUID = '164126AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA' then cna.name end) "EID Reason for testing",
