...
@Component
public class NCDQuarterly extends ApzuReportManager {

    public static final String SQL_DATA_SET_RESOURCE = "org/openmrs/module/pihmalawi/reporting/datasets/sql/ncd-quarterly.sql";
    public static final String EXCEL_REPORT_DESIGN_UUID = "fe8e90fd-6a49-4022-8be2-84977270ff3c";
    public static final String LOCATION_NAME_PARAM = "location";


    @Override
    public String getUuid() {
        return "2c2ea532-8b4c-490d-9a63-f6b5922d94df";
    }
    ...
    public String getDescription() {
        return "NCD Quarterly Report, Revision September 2026";
    }
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        rd.addDataSetDefinition("ncdQuarterly", Mapped.mapStraightThrough(dsd));
    ...
    public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
        ...
        ReportDesign design = createExcelTemplateDesign(EXCEL_REPORT_DESIGN_UUID, reportDefinition, "NCDQuarterlyReport.xls");
        design.addPropertyValue("repeatingSections", "sheet:1,row:5,dataset: ncdQuarterly");
        l.add(design);
        return l;
    }
