 ...
 *
 */
public class EncounterAndObsDataSetObsColumnDescriptor implements Comparable<EncounterAndObsDataSetObsColumnDescriptor> {

	private List<Concept> conceptHeirarchy;
	private List<Integer> conceptOccurrenceHeirarchy;
	
	public EncounterAndObsDataSetObsColumnDescriptor() {
		super();
	}
	
	public EncounterAndObsDataSetObsColumnDescriptor(Obs o, Map<Obs, Integer> fieldMap) {
		if (o != null)
			do {
				int occurrence = -1;
	...
	public int compareTo(EncounterAndObsDataSetObsColumnDescriptor otherObsColumnDescriptor) {

		List<Concept> otherConceptHeirarchy = ((EncounterAndObsDataSetObsColumnDescriptor) otherObsColumnDescriptor).getConceptHeirarchy();
		List<Integer> otherConceptOccurrenceHeirarchy = ((EncounterAndObsDataSetObsColumnDescriptor) otherObsColumnDescriptor).getConceptOccurrenceHeirarchy();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		EncounterAndObsDataSetObsColumnDescriptor other = (EncounterAndObsDataSetObsColumnDescriptor) obj;
