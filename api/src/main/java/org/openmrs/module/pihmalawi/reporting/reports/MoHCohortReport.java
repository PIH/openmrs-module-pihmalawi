...
@Component
public class MoHCohortReport extends ApzuReportManager {

    public static final String SQL_DATA_SET_RESOURCE = "org/openmrs/module/pihmalawi/reporting/datasets/sql/moh-cohort-report.sql";
    public static final String EXCEL_REPORT_DESIGN_UUID = "08aab71d-f6e9-44d7-9006-878a135381d2";


    @Override
    public String getUuid() {
        return "0a148f59-bca5-4b31-9b83-d8d0f911aa21";
    }

    @Override
    public String getName() {
        return "MOH - Cohort Report";
    }

    @Override
    public String getDescription() {
        return "MOH Cohort Report, Revision January 2026";
    }
    ...
    public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
        ...
        ReportDesign design = createExcelTemplateDesign(EXCEL_REPORT_DESIGN_UUID, reportDefinition, "MohCohortReport.xls");
