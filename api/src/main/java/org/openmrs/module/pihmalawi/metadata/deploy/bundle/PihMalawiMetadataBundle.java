...
@Component
@Requires( {PalliativeCareConcepts.class, MasterCardConcepts.class, ChwManagementConcepts.class, ChronicHeartFailureConcepts.class, ChronicKidneyDiseaseConcepts.class, IC3ScreeningConcepts.class} )
