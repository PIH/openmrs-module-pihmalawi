...
public class EncounterAndObsDataSetEvaluator implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context) throws EvaluationException {
		...
		if (columnDisplayFormat == null) {
			columnDisplayFormat = new ArrayList<EncounterAndObsDataSetDefinition.ColumnDisplayFormat>();
		}
		...
		Map<Encounter, Map<EncounterAndObsDataSetObsColumnDescriptor, Obs>> populatedFieldMap = populateFieldMap(encounters);
		
		// Keeps track of the column headers for all obs-related columns
		Set<EncounterAndObsDataSetObsColumnDescriptor> allColumns = new TreeSet<EncounterAndObsDataSetObsColumnDescriptor>();

		for(Encounter encounter : encounters) {
			Map<EncounterAndObsDataSetObsColumnDescriptor, Obs> obsInEncounter = populatedFieldMap.get(encounter);
	 ...
	 */
	public Map<Encounter, Map<EncounterAndObsDataSetObsColumnDescriptor, Obs>> populateFieldMap(List<Encounter> encounters) {

		// Create a map to keep track of obs and their occurrences for each encounter
		// TODO: Can this be optimized?
		Map<Encounter, Map<EncounterAndObsDataSetObsColumnDescriptor, Obs>> allEncounters = new HashMap<Encounter, Map<EncounterAndObsDataSetObsColumnDescriptor, Obs>>();
		...
		for (Encounter e : encounters) {
			...
			Map<EncounterAndObsDataSetObsColumnDescriptor, Obs> obsInEncounter = new HashMap<EncounterAndObsDataSetObsColumnDescriptor, Obs>();
			...
			for (Obs obs : e.getObs()) {
				...
				if (obs != null) {
					...
					EncounterAndObsDataSetObsColumnDescriptor obsKey = new EncounterAndObsDataSetObsColumnDescriptor(obs, fieldMap);
	...
	public DataSet addData(SimpleDataSet dataSet, List<Encounter> encounters, List<PatientIdentifierType> patientIdentifierTypes, List<EncounterAndObsDataSetDefinition.ObsOptionalColumn> optionalColumns, List<EncounterAndObsDataSetDefinition.ColumnDisplayFormat> columnDisplayFormat, Integer maxColumnHeaderWidth, Set<EncounterAndObsDataSetObsColumnDescriptor> allColumns, Map<Encounter, Map<EncounterAndObsDataSetObsColumnDescriptor, Obs>> fieldMap) {
		for (Encounter encounter : encounters) {
			...
			row.addColumnValue(c2, formatEncounterDate(encounter.getEncounterDatetime()));
