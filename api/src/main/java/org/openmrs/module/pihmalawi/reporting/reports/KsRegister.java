...
import org.openmrs.module.pihmalawi.reporting.definition.renderer.KsRegisterBreakdownRenderer;
...
public class KsRegister extends ApzuReportManager {
	...
	@Autowired
	private KaposiSarcomaMetadata metadata;

	public KsRegister() {}

	@Override
	public String getUuid() {
		return "f677c473-06a0-11e4-b4d8-54ee7513a7ff";
	}
	...
	public ReportDefinition constructReportDefinition() {
		...
		ecd.setEncounterTypeList(metadata.getKaposiSarcomaEncounterTypes());
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		...
		try {
			...
			dsd.setPatientIdentifierType(metadata.getKsNumberIdentifierType());
			...
			throw new IllegalStateException("Unable to create renderer for KS Register", e);
		}
