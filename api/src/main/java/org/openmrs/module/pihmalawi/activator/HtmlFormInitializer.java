...
public class HtmlFormInitializer implements Initializer {
	...
	public synchronized void started() {
        ...
        List<String> uiHtmlForms = Arrays.asList(
                ...
                "pihmalawi:htmlforms/mental_health_screening.xml",
				...
				"pihmalawi:htmlforms/chf_echocardiogram.xml",
				"pihmalawi:htmlforms/chf_ekg.xml",
				"pihmalawi:htmlforms/chf_cxr.xml",
				...
				"pihmalawi:htmlforms/hie_dev_delay_lab_tests.xml",
				...
				"pihmalawi:htmlforms/pdc_trisomy21_lab_tests.xml",
				...
				"pihmalawi:htmlforms/nutrition_infant_visit.xml",
				"pihmalawi:htmlforms/nutrition_pdc_mastercard.xml",
				...
				"pihmalawi:htmlforms/sickle_cell_mastercard.xml",
				...
				"pihmalawi:htmlforms/tb_tests.xml",
				"pihmalawi:htmlforms/tb_post_lung_disease.xml"
				);
