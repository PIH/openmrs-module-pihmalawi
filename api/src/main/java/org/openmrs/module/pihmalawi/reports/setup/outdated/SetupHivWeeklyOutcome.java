...
public class SetupHivWeeklyOutcome {
	...
	public SetupHivWeeklyOutcome(ReportHelper helper) {
		h = helper;
	}
...
//		ReportDesign rdes = createHtmlBreakdownArt(rd);
	...
	private void createIndicators() {
		...
		newCountIndicatorForLocationsWithState("hiv: Died from On ART", "hiv: In state at location from On ART_", MetadataLookup
		...
		newCountIndicatorForLocationsWithState("hiv: Transferred out from On ART",
		    "hiv: In state at location from On ART_", MetadataLookup.workflowState("HIV program", "Treatment status",
		...
		newCountIndicatorForLocationsWithState("hiv: Treatment stopped from On ART", "hiv: In state at location from On ART_",
				MetadataLookup.workflowState("HIV program", "Treatment status", "Treatment stopped"));
	...
	private void createCohortDefinitions() {
		...
		iscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "On antiretrovirals")));
		iscd.addParameter(new Parameter("onDate", "endDate", Date.class));
		h.replaceCohortDefinition(iscd);
		...
		iscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "Treatment stopped")));
		iscd.addParameter(new Parameter("onDate", "endDate", Date.class));
		h.replaceCohortDefinition(iscd);
		...
		iscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "Patient transferred out")));
		iscd.addParameter(new Parameter("onDate", "endDate", Date.class));
		h.replaceCohortDefinition(iscd);
		...
		iscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "Patient died")));
		iscd.addParameter(new Parameter("onDate", "endDate", Date.class));
		h.replaceCohortDefinition(iscd);
		...
		pscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "On antiretrovirals")));
		...
		iscd.setStates(Arrays.asList(MetadataLookup.workflowState("HIV program", "Treatment status", "Pre-ART (Continue)")));
		...
		map.put("state", MetadataLookup.workflowState("HIV program", "Treatment status", "On antiretrovirals"));
	...
	private void addColumnForLocations(PeriodIndicatorReportDefinition rd, String displayNamePrefix, String indicator,
	                                   String indicatorKey) {
		for (Location l : ApzuReportElementsArt.hivStaticLocations()) {
			PeriodIndicatorReportUtil.addColumn(rd, indicatorKey + ApzuReportElementsArt.hivSiteCode(l), displayNamePrefix + " (" + l.getName() + ")", h
	...
	private void addColumnForLocationsWithState(PeriodIndicatorReportDefinition rd, String displayNamePrefix,
		...
		PeriodIndicatorReportUtil.addColumn(rd, indicatorKey + ApzuReportElementsArt.hivSiteCode(l), displayNamePrefix + " (" + l.getName() + ")",
