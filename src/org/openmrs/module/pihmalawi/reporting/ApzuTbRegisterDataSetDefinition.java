...
public class ApzuTbRegisterDataSetDefinition extends BaseDataSetDefinition {
	...
	public ApzuTbRegisterDataSetDefinition() {
		super();
	}
	
	public ApzuTbRegisterDataSetDefinition(String name, String description) {
