...
# 0 2 1/3 * * /home/emradmin/script_reports/run_monthly_reports_nno.sh >> /dev/null
...
run_report.sh \
  ...
  "" \
  $FILE
echo "" | mailx -a $FILE -s "emr: Upper Neno Quarterly APZU HIV Indicators $YESTERDAY" "$MAIL"
mv $FILE /home/emradmin/pihmalawi/scripts/history
