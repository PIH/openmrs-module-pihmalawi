...
import org.openmrs.module.pihmalawi.reporting.reports.MohTxNewReport;
 ...
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohTxNewReportRestController.PIHMALAWI + MohTxNewReportRestController.REPORT)
public class MohTxNewReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-tx_new-report";

    @Autowired
    MohTxNewReport mohTxNewReport;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(mohTxNewReport);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(mohTxNewReport.getUuid());
