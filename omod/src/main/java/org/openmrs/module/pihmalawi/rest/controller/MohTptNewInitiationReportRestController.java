...
import org.openmrs.module.pihmalawi.reporting.reports.MohTptNewInitiationReport;
...
/**
 *  End point will handle getting of MoH Tpt New Initiation Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohTptNewInitiationReportRestController.PIHMALAWI + MohTptNewInitiationReportRestController.REPORT)
public class MohTptNewInitiationReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-tpt-new-initiation";

    @Autowired
    MohTptNewInitiationReport mohTptNewInitiationReport;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(mohTptNewInitiationReport);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(mohTptNewInitiationReport.getUuid());
    ...
    public List<SimpleObject> getReportData(DataSet d) {
        ...
        List<SimpleObject> dataList = new ArrayList<SimpleObject>();
            while (iterator.hasNext())
            {
                ...
                reportDetails.add("district",r.getColumnValue("district"));
                ...
                reportDetails.add("txNewEligibleTpt",r.getColumnValue("tx_new_eligible_tpt"));
