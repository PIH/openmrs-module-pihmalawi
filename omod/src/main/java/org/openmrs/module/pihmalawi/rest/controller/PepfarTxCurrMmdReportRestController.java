...
/**
 *  End point will handle getting of PEPFAR TX Curr MMD Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + PepfarTxCurrMmdReportRestController.PIHMALAWI + PepfarTxCurrMmdReportRestController.REPORT)
public class PepfarTxCurrMmdReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/pepfar-tx-curr-mmd";

    @Autowired
    PepfarTxMmdReport pepfarTxMmdReport;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(pepfarTxMmdReport);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(pepfarTxMmdReport.getUuid());
