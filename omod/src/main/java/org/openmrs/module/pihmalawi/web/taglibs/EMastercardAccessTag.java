...
public class EMastercardAccessTag extends BodyTagSupport {
    ...
    protected String getNewMasterCardConfiguration(Form f) {
        ...
        m.put(HivMetadata.ART_INITIAL, "headerForm=art_mastercard&flowsheets=bp_screening&flowsheets=art_visit");
        ...
        m.put(EncounterTypes.HTN_DIABETES_INITIAL.name(), "headerForm=htn_dm_mastercard&flowsheets=htn_dm_labs&flowsheets=htn_dm_hospital&flowsheets=htn_dm_visit");
