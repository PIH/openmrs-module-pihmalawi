...
import org.openmrs.module.pihmalawi.reporting.reports.MohSurvivalAnalysisChildren;
...
/**
 *  End point will handle getting of MoH Survival Analysis Children Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohSurvivalAnalysisChildrenReportRestController.PIHMALAWI + MohSurvivalAnalysisChildrenReportRestController.REPORT)
public class MohSurvivalAnalysisChildrenReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-survival-analysis-children";

    @Autowired
    MohSurvivalAnalysisChildren mohSurvivalAnalysisChildren;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(mohSurvivalAnalysisChildren);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(mohSurvivalAnalysisChildren.getUuid());
