...
import org.openmrs.module.pihmalawi.reporting.reports.MohTxMmdReport;
import org.openmrs.module.pihmalawi.reporting.reports.PepfarTxMmdReport;
...
/**
 *  End point will handle getting of MoH TX_Curr MMD Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohTxCurrMmdReportRestController.PIHMALAWI + MohTxCurrMmdReportRestController.REPORT)
public class MohTxCurrMmdReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-tx-curr-mmd";

    @Autowired
    MohTxMmdReport mohTxMmdReport;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(mohTxMmdReport);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(mohTxMmdReport.getUuid());
    ...
    public List<SimpleObject> getReportData(DataSet d) {
        ...
        List<SimpleObject> dataList = new ArrayList<SimpleObject>();
            while (iterator.hasNext())
            {
                ...
                reportDetails.add("lessThanThreeMonths",r.getColumnValue("less_than_three_months"));
                reportDetails.add("threeToFiveMonths",r.getColumnValue("three_to_five_months"));
                reportDetails.add("sixMonthsPlus",r.getColumnValue("six_months_plus"));
