...
import org.openmrs.module.pihmalawi.reporting.reports.MohSurvivalAnalysisGeneral;
...
/**
 *  End point will handle getting of MoH Survival Analysis General Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohSurvivalAnalysisGeneralReportRestController.PIHMALAWI + MohSurvivalAnalysisGeneralReportRestController.REPORT)
public class MohSurvivalAnalysisGeneralReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-survival-analysis-general";

    @Autowired
    MohSurvivalAnalysisGeneral mohSurvivalAnalysisGeneral;
       ...
       try
        {
            ...
            ReportManagerUtil.setupReport(mohSurvivalAnalysisGeneral);
            ReportUtil.updateGlobalProperty(ReportingConstants.GLOBAL_PROPERTY_DATA_EVALUATION_BATCH_SIZE, "-1");
            ReportUtil.updateGlobalProperty(ReportingConstants.DEFAULT_LOCALE_GP_NAME, "en");
            ReportDefinition rd = reportDefinitionService.getDefinitionByUuid(mohSurvivalAnalysisGeneral.getUuid());
