...
/**
 *  End point will handle getting of MoH Cohort Disaggregated Report
 */
@Controller
@RequestMapping(value = "/rest/" + RestConstants.VERSION_1 + MohCohortDisaggregatedReportRestController.PIHMALAWI + MohCohortDisaggregatedReportRestController.REPORT)
public class MohCohortDisaggregatedReportRestController {
    public static final String PIHMALAWI = "/pihmalawi";
    public static final String REPORT = "/report/moh-cohort-disaggregated";
