...
public class NcdInwardSummaryPageController {
	...
	public void controller(@RequestParam(value="patientId", required=false) Patient patient,
        ...
        add(dsd, "village", baseData.getVillage());
        add(dsd, "chw", baseData.getChw());
        ...
        add(dsd, "htnDiagnosis", ccData.getHypertensionDiagnosis());
        add(dsd, "dmDiagnosis", ccData.getDiabetesDiagnosis());
        add(dsd, "epilepsyDiagnosis", ccData.getEpilepsyDiagnosis());
        add(dsd, "asthmaDiagnosis", ccData.getAsthmaDiagnosis());
        add(dsd, "copdDiagnosis", ccData.getCopdDiagnosis());
        add(dsd, "ncdDiagnoses", ccData.getAllChronicCareDiagnosesByEndDate());
