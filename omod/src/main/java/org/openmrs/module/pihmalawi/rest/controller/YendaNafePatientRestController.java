...
public class YendaNafePatientRestController {
    ...
    public Object createPatient(
        ...
        try{
            ...
            Patient newPatient = yendaNafePatientRegistrationService.createPatient(body,YENDANAFEUIID,personService,patientService,userService,locationService, PihMalawiConfigConstants.PATIENTIDENTIFIERTYPE_YENDANAFE_IDENTIFIER_UUID);
